...
#if 0
class MatchActionIndirectTable : public tdi::Table {
 public:
  MatchActionIndirectTable(const std::string &program_name,
                               tdi_id_t id,
                               std::string name,
                               const size_t &size,
  ...
  tdi_status_t tableSizeGet(const tdi::Session &session,
                           const tdi::Target &dev_tgt,
                           const tdi::Flags &flags,
...
class SelectorTable : public tdi::Table {
 public:
  ...
  tdi_status_t getOneMbr(const tdi::Session &session,
