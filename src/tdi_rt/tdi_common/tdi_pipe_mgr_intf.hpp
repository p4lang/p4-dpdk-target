...
class IPipeMgrIntf {
 public:
  ...
  virtual pipe_status_t pipeMgrFlowLrnTimeoutGet(tdi_dev_id_t device_id,
                                                 uint32_t *usecs) = 0;
  ...
  virtual pipe_status_t pipeMgrFlowLrnSetNetworkOrderDigest(
      tdi_dev_id_t device_id, bool network_order) = 0;
  ...
  virtual pipe_status_t pipeStfulParamGetHdl(tdi_dev_id_t dev,
                                             const char *name,
                                             pipe_reg_param_hdl_t *rp_hdl) = 0;
  ...
  virtual tdi_status_t bfDbgCounterGet(bf_dev_target_t dev_tgt,
                                       char *tbl_name,
  ...
  virtual tdi_status_t bfDbgCounterSet(bf_dev_target_t dev_tgt,
                                       char *tbl_name,
  ...
  virtual tdi_status_t bfDbgCounterClear(bf_dev_target_t dev_tgt,
                                         char *tbl_name) = 0;
  ...
  virtual tdi_status_t bfDbgCounterTableListGet(bf_dev_target_t dev_tgt,
                                                char **tbl_list,
                                                int *num_tbls) = 0;
...
class PipeMgrIntf : public IPipeMgrIntf {
 public:
  ...
  pipe_status_t pipeMgrFlowLrnTimeoutSet(pipe_sess_hdl_t sess_hdl,
                                         tdi_dev_id_t device_id,
                                         uint32_t usecs);
  pipe_status_t pipeMgrFlowLrnTimeoutGet(tdi_dev_id_t device_id,
                                         uint32_t *usecs);
  ...
  pipe_status_t pipeMgrFlowLrnIntrModeGet(pipe_sess_hdl_t sess_hdl,
                                          tdi_dev_id_t device_id,
                                          bool *en);
  pipe_status_t pipeMgrFlowLrnSetNetworkOrderDigest(tdi_dev_id_t device_id,
                                                    bool network_order);
  ...
  pipe_status_t pipeStfulParamGetHdl(tdi_dev_id_t dev,
                                     const char *name,
                                     pipe_reg_param_hdl_t *rp_hdl);
  ...
  tdi_dev_pipe_t pipeGetHdlPipe(pipe_mat_ent_hdl_t entry_hdl);

  /************ Table Debug Counters APIs **************/
  tdi_status_t bfDbgCounterGet(bf_dev_target_t dev_tgt,
                               char *tbl_name,
                               bf_tbl_dbg_counter_type_t *type,
                               uint32_t *value);
  ...
  tdi_status_t bfDbgCounterSet(bf_dev_target_t dev_tgt,
                               uint32_t stage,
                               uint32_t log_tbl,
                               bf_tbl_dbg_counter_type_t type);
  ...
  tdi_status_t bfDbgCounterClear(bf_dev_target_t dev_tgt, char *tbl_name);

  tdi_status_t bfDbgCounterClear(bf_dev_target_t dev_tgt,
                                 uint32_t stage,
                                 uint32_t log_tbl);

  tdi_status_t bfDbgCounterTableListGet(bf_dev_target_t dev_tgt,
                                        char **tbl_list,
                                        int *num_tbls);
