...
pipe_status_t PipeMgrIntf::pipeMgrFlowLrnTimeoutGet(tdi_dev_id_t device_id,
                                                    uint32_t *usecs) {
	return TDI_SUCCESS;
}
...
pipe_status_t PipeMgrIntf::pipeMgrFlowLrnSetNetworkOrderDigest(
    tdi_dev_id_t device_id, bool network_order) {
...
pipe_status_t PipeMgrIntf::pipeStfulParamGetHdl(tdi_dev_id_t dev,
                                                const char *name,
                                                pipe_reg_param_hdl_t *rp_hdl) {
	return TDI_SUCCESS;
}

tdi_dev_pipe_t PipeMgrIntf::devPortToPipeId(uint16_t dev_port_id) {
...
pipe_status_t PipeMgrIntf::pipeMgrGetActionDataEntry(
  ...
  return pipe_mgr_get_action_data_entry(
      sess_hdl, tbl_hdl, dev_id, entry_hdl, data_spec, act_fn_hdl, from_hw);
}
...
tdi_dev_pipe_t PipeMgrIntf::pipeGetHdlPipe(pipe_mat_ent_hdl_t entry_hdl) {
  return PIPE_GET_HDL_PIPE(entry_hdl);
}

/************ Table Debug Counters APIs **************/
tdi_status_t PipeMgrIntf::bfDbgCounterGet(bf_dev_target_t dev_tgt,
                                         char *tbl_name,
...
tdi_status_t PipeMgrIntf::bfDbgCounterSet(bf_dev_target_t dev_tgt,
                                         char *tbl_name,
                                         bf_tbl_dbg_counter_type_t type) {
...
tdi_status_t PipeMgrIntf::bfDbgCounterClear(bf_dev_target_t dev_tgt,
                                           char *tbl_name) {
	return TDI_SUCCESS;
}
...
tdi_status_t PipeMgrIntf::bfDbgCounterTableListGet(bf_dev_target_t dev_tgt,
                                                  char **tbl_list,
                                                  int *num_tbls) {
	return TDI_SUCCESS;
}
...
pipe_status_t PipeMgrIntf::pipeMgrGetNumPipelines(tdi_dev_id_t dev_id,
                                                  uint32_t *num_pipes) const {
  return pipe_mgr_get_num_pipelines(dev_id, num_pipes);
}

tdi_status_t PipeMgrIntf::pipeMgrEnablePipeline(tdi_dev_id_t dev_id) const {
