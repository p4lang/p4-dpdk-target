...
#define PORT_CONFIG_JSON_NET_PORT "net_port"
...
{
	int dev_port, port_in_id = 0, port_out_id = 0, net_port = 0;
	char *port_name = NULL;
	...
	err |= bf_cjson_try_get_int(port_cjson, PORT_CONFIG_JSON_NET_PORT,
				&net_port);
	port_info->port_attrib.net_port = net_port;
